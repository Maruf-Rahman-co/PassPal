    ...
    <Card className="p-6 space-y-6">
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium">Passphrase Settings</h3>
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="space-y-4">
        <div className="flex flex-col space-y-2">
          ...
          <div className="relative">
            <div className="min-h-[60px] p-3 bg-muted rounded-md flex items-center justify-center text-center break-all">
